...
#CplxMeanSquaredError = mean_squared_error.CplxMeanSquaredError
...
concat = concat.concat
copy = copy.copy
#cplx_dropout = dropout.cplx_dropout
dropout = dropout.dropout
gaussian = gaussian.gaussian
identity = identity.identity
reshape = reshape.reshape
...
#cplx_mean_squared_error = mean_squared_error.cplx_mean_squared_error
